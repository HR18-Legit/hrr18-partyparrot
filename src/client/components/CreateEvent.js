...
export default class CreateEvent extends React.Component {
  ...
  search(keyword, location){
    var url = `https://www.eventbriteapi.com/v3/events/search/?q=${keyword}&sort_by=best&location.address=${location}&token=S7EHOAZMNQCFF27IFV`;
  ...
  searchId(id){
    var url = `https://www.eventbriteapi.com/v3/events/${id}/?token=S7EHOAZMNQCFF27IFV`;
    Request.get(url).then((response) => {
      this.setState({
        event: response.body
      });
