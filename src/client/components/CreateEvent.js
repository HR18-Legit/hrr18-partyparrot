...
export default class CreateEvent extends React.Component {
  ...
  search(keyword, location){
    var url = `https://www.eventbriteapi.com/v3/events/search/?q=${keyword}&sort_by=best&location.address=${location}&token=7RMWHXP6CK2F2HSP6OSI`;
  ...
  searchId(id){
    var url = `https://www.eventbriteapi.com/v3/events/${id}/?token=7RMWHXP6CK2F2HSP6OSI`;
    Request.get(url).then((response) => {
      this.setState({
        event: response.body
      });
